...
MODELS_128_DONE=("Llama-3.2-1B-Instruct" "Llama-3.2-3B-Instruct" "Meta-Llama-3.1-8B-Instruct" "Phi-3.5-mini-instruct" "Phi-3-medium-4k-instruct" "mistral-7b-instruct-v0.3" "Qwen2.5-14B-Instruct" "Qwen2.5-7B-Instruct" "Qwen2.5-3B-Instruct" "Qwen2.5-1.5B-Instruct" "Qwen2.5-0.5B-Instruct")

for model in "${MODELS_16[@]}"; do
    python3 train.py --model_name $model --batch_size 16 --learning_rate 1e-4 --lora_rank 16 --num_epochs 5 --push_to_hub --resume_from_checkpoint
done
